...
var config = {
  map: {
    '*': {
      aboutUsStoreDesign: 'MxStarbucks_BWPageBuild/js/aboutUsStoreDesign',
    },
  },
  deps: ["MxStarbucks_BWPageBuild/js/aboutUsStoreDesign"],
}
...
var config = {
  map: {
    '*': {
      swiperBundle: 'MxStarbucks_BWProduct/js/lib/swiper_bundle.min',
    },
  },
}
...
var config = {
    map: {
        '*':{
            mobile_input_focus:'MxStarbucks_Customer/js/mobile-input-focus',
            sign_in_fun:'MxStarbucks_Customer/js/sign-in-fun',
            verf_time_countdown:'MxStarbucks_Customer/js/verf-time-countdown',
            create_pwd_check:'MxStarbucks_Customer/js/create-pwd-check',
            keepSignSwitch:'MxStarbucks_Customer/js/keep-sign-switch',
            select: 'MxStarbucks_Customer/js/select',
            xssFilter:'MxStarbucks_Customer/js/common/xss'
        }
    },
    config: {
        mixins: {
            'mage/validation': {
                'MxStarbucks_Customer/js/validation': true
            }
        }
    }
};
...
var config = {
    map: {
        '*':{
            mobileDetect:"MxStarbucks_DownloadApp/js/mobile-detect"
        }
    }
};
...
var config = {
    map: {
        '*':{
            html2canvas:"MxStarbucks_EGift/js/fun/html2canvas",
            jsPDF:"MxStarbucks_EGift/js/fun/jspdf",
            qrcode: "MxStarbucks_EGift/js/fun/qrcode"
        }
    }
};
...
var config = 
{
    map: 
    {
        '*': 
        {
           // 'OnTap_MasterCard/view/frontend/web/js/view/payment/threedsecure':'CustomOnTap_MasterCard/view/frontend/web/js/view/payment/threedsecure',
            'OnTap_MasterCard/js/view/payment/threedsecure':'CustomOnTap_MasterCard/js/view/payment/threedsecure',
            'OnTap_MasterCard/js/view/payment/method-renderer/tns-hpf': 'CustomOnTap_MasterCard/js/view/payment/method-renderer/tns-hpf',
        }
    }
};
require.config(config);
...
var config = {
    map: {
        '*':{
            "menu":"MxStarbucks_Navigation/js/menu",
        }
    }
};
...
var config = {
    map: {
            '*': {
                citigeneral: 'Deloitte_CitibankRedemption/js/citigeneral',
                otpverification: 'Deloitte_CitibankRedemption/js/otpverification'
            }
        }
    };
require.config(config);
